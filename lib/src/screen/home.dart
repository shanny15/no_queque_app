                        ...
                        Padding(
                          ...
                          child: RichText(text: TextSpan(
                              children: [
                                ...
                                TextSpan(text: "\Ksh. ", style: TextStyle(color: white.withOpacity(0.5), fontSize: 20)),
                                TextSpan(text: "1,500.00 \n", style: TextStyle(color: white, fontSize: 30)),
                    ...
                    Container(
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          ...
                          CreditCard(color: "00A600", number: 656, image: "mpesa2.png", valid: "",),
                          CreditCard(color: "2a1214", number: 1234, image: "master.png", valid: "VALID 10/22",),
                          CreditCard(color: "000068", number: 4560, image: "visa.png", valid: "VALID 07/24",),
                        ],
                      ),
                    ),
                    SizedBox(height: 5,),
        ...
        bottomNavigationBar: Container(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("", style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: grey),),
              ),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("", style: TextStyle(fontSize: 22, fontWeight: FontWeight.w600, color: grey),),
